...
<div class="notice notice-info is-dismissible wpdt-promo-notice">
            <div id="wpdt-promo-section">
                <div id="wpdt-first-section">
                    <img class="wpdt-promo-logo" src="<?php echo WDT_ROOT_URL ?>assets/img/promo/additional-exclusive-offer.png" alt="">
                </div>
                <div id="wpdt-second-section">
                    <img class="wpdt-promo-discounts" src="<?php echo WDT_ROOT_URL ?>assets/img/promo/additional-promo-discounts.png" alt="">
                </div>
