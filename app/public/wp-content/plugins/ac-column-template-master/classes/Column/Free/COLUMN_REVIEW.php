...
class COLUMN_REVIEW extends \AC\Column {

	public function __construct() {

		// Identifier, pick an unique name. Single word, no spaces. Underscores allowed.
		$this->set_type( 'column-COLUMN_REVIEW' );

		// Default column label.
		$this->set_label( __( 'COLUMN_REVIEW', 'ac-COLUMN_REVIEW' ) );
	}
	...
	public function scripts() {
		...
		wp_enqueue_script( 'ac-COLUMN_REVIEW', plugin_dir_url( __FILE__ ) . "../../../js/review.js" );
		wp_enqueue_style( 'ac-COLUMN_REVIEW', plugin_dir_url( __FILE__ ) . "../../../css/review.css" );
	}
