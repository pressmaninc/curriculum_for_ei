...
class COLUMN_BOOK extends \AC\Column {

	public function __construct() {

		// Identifier, pick an unique name. Single word, no spaces. Underscores allowed.
		$this->set_type( 'column-COLUMN_BOOK' );

		// Default column label.
		$this->set_label( __( 'COLUMN_BOOK', 'ac-COLUMN_BOOK' ) );
	}
	...
	public function scripts() {
		...
		wp_enqueue_script( 'ac-COLUMN_BOOK', plugin_dir_url( __FILE__ ) . "../../../js/book.js" );
		wp_enqueue_style( 'ac-COLUMN_BOOK', plugin_dir_url( __FILE__ ) . "../../../css/book.css" );
	}
